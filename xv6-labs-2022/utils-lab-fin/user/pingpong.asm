...
main(int argc, char *argv[])
{
  ...
  12:	89258593          	addi	a1,a1,-1902 # 8a0 <malloc+0xe8>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	6b4080e7          	jalr	1716(ra) # 6cc <fprintf>
    exit(1);
  20:	4505                	li	a0,1
  22:	00000097          	auipc	ra,0x0
  26:	360080e7          	jalr	864(ra) # 382 <exit>
  }
  ...
  32:	364080e7          	jalr	868(ra) # 392 <pipe>
  pipe(parentp);
  36:	fd040513          	addi	a0,s0,-48
  3a:	00000097          	auipc	ra,0x0
  3e:	358080e7          	jalr	856(ra) # 392 <pipe>

  
  int pid = fork();
  42:	00000097          	auipc	ra,0x0
  46:	338080e7          	jalr	824(ra) # 37a <fork>
  
  if(pid > 0){ //parent
  4a:	04a05b63          	blez	a0,a0 <main+0xa0>
 
    write(parentp[1], "ping", 4);
  4e:	4611                	li	a2,4
  50:	00001597          	auipc	a1,0x1
  54:	86858593          	addi	a1,a1,-1944 # 8b8 <malloc+0x100>
  58:	fd442503          	lw	a0,-44(s0)
  5c:	00000097          	auipc	ra,0x0
  60:	346080e7          	jalr	838(ra) # 3a2 <write>
    
    read(childp[0], buf, 4);
  64:	4611                	li	a2,4
  66:	fe040593          	addi	a1,s0,-32
  6a:	fd842503          	lw	a0,-40(s0)
  6e:	00000097          	auipc	ra,0x0
  72:	32c080e7          	jalr	812(ra) # 39a <read>

    fprintf(2, "%d: received %s\n", getpid(), buf);
  76:	00000097          	auipc	ra,0x0
  7a:	38c080e7          	jalr	908(ra) # 402 <getpid>
  7e:	862a                	mv	a2,a0
  80:	fe040693          	addi	a3,s0,-32
  84:	00001597          	auipc	a1,0x1
  88:	83c58593          	addi	a1,a1,-1988 # 8c0 <malloc+0x108>
  8c:	4509                	li	a0,2
  8e:	00000097          	auipc	ra,0x0
  92:	63e080e7          	jalr	1598(ra) # 6cc <fprintf>
    exit(0);    
  }
  ...
  a6:	fd042503          	lw	a0,-48(s0)
  aa:	00000097          	auipc	ra,0x0
  ae:	2f0080e7          	jalr	752(ra) # 39a <read>
    fprintf(2, "%d: received %s\n", getpid(), buf);    
  b2:	00000097          	auipc	ra,0x0
  b6:	350080e7          	jalr	848(ra) # 402 <getpid>
  ba:	862a                	mv	a2,a0
  bc:	fe040693          	addi	a3,s0,-32
  c0:	00001597          	auipc	a1,0x1
  c4:	80058593          	addi	a1,a1,-2048 # 8c0 <malloc+0x108>
  c8:	4509                	li	a0,2
  ca:	00000097          	auipc	ra,0x0
  ce:	602080e7          	jalr	1538(ra) # 6cc <fprintf>
    write(childp[1], "pong", 4);
  d2:	4611                	li	a2,4
  d4:	00001597          	auipc	a1,0x1
  d8:	80458593          	addi	a1,a1,-2044 # 8d8 <malloc+0x120>
  dc:	fdc42503          	lw	a0,-36(s0)
  e0:	00000097          	auipc	ra,0x0
  e4:	2c2080e7          	jalr	706(ra) # 3a2 <write>
    exit(0);    
  e8:	4501                	li	a0,0
  ea:	00000097          	auipc	ra,0x0
  ee:	298080e7          	jalr	664(ra) # 382 <exit>
